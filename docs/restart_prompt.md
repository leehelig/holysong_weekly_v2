...
아래 다섯 개 파일을 기준(Single Source of Truth)으로만 대화해라:
1) progress.md
2) today_task.md
3) 00_overall_architecture.md
4) TDD 개발을 위한 모든 Task 공통 절차
5) 30_task.md
...
오늘 해야 할 작업은 today_task.md의 '첫 번째 미완료 태스크'부터 시작한다.
...
지금부터 today_task.md의 첫 번째 미완료 항목부터 이어서 개발해라.
