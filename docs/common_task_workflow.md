...
❗ UI까지 올라간 이후의 오류는 3~5배 더 어렵다.  
반드시 이 단계에서 최대한 잡는다.

---

## 5️⃣ PRD 일치 검증 (Final Check)

**30_functions_weekly.md** 또는 관련 명세서와 정확히 일치하는지 검증한다.

체크 항목:
- 함수 시그니처 일치?
- 반환 타입 일치?
- 예외 처리 규칙 일치?
- WeeklyWorship JSON 구조 일치?
- overall_architecture 규칙 준수?
...
모든 Task(모델/레포/서비스/뷰모델/UI)는  
**반드시 아래 공통 5단계를 따라야 한다.**

| 단계 | 이름 | 내용 |
|------|------|------|
| 1️⃣ | 준비 | 필요한 정보 수집 |
| 2️⃣ | TDD 설계 | 테스트 조건 정의 |
| 3️⃣ | 구현 | 코드 작성 |
| 4️⃣ | 테스트 | 결과 검증 |
| 5️⃣ | PRD 체크 | 명세서와 일치 여부 확인 |
